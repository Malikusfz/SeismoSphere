...
const colorPalette = {
  ...
  cardGradient: 'linear-gradient(120deg, rgba(255,255,255,0.95) 0%, rgba(249,250,251,0.9) 100%)',
  darkCardGradient: 'linear-gradient(120deg, rgba(45,55,72,0.95) 0%, rgba(26,32,44,0.9) 100%)',
